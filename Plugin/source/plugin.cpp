...
void OnVRButtonEvent(PapyrusVR::VREventType type, PapyrusVR::EVRButtonId buttonId, PapyrusVR::VRDevice deviceId)
{
    ...
    */
    ...
    if (VOX_PushToSpeakType->value == 0 || VOX_PushToSpeakType->value == 3 || (buttonId + vrLeftOffset != VOX_PushToSpeakKeyCode->value && buttonId + vrRightOffset != VOX_PushToSpeakKeyCode->value))  // Check if PushToSpeak is disabled OR triggering buttonId does NOT match target input value from VOX MCM
        return; // Exit this method
