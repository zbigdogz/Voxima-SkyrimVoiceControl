...
namespace PapyrusVR {
    ...
    public:
        ...
        virtual uint32_t CreateLocalOverlapSphere(float radius, Matrix34* transform, VRDevice attachedDevice = VRDevice::VRDevice_Unknown) = 0;
        virtual void DestroyLocalOverlapObject(uint32_t overlapObjectHandle) = 0;
