...
namespace PapyrusVR {
    ...
    enum VRDevice { VRDevice_Unknown = -1, VRDevice_HMD = 0, VRDevice_RightController = 1, VRDevice_LeftController = 2 };

    enum VREvent { VREvent_Negative = -1, VREvent_None = 0, VREvent_Positive = 1 };

    enum VREventType { VREventType_Touched = 0, VREventType_Untouched = 1, VREventType_Pressed = 2, VREventType_Released = 3 };

    enum VROverlapEvent { VROverlapEvent_None = 0, VROverlapEvent_OnEnter = 1, VROverlapEvent_OnExit = 2 };
}