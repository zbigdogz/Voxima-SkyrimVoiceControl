...
namespace PapyrusVR {
    ...
    Matrix33 Matrix33FromTransform(Matrix34 const* matrix) {
        Matrix33 result =
            Matrix33(matrix->m[0][0], matrix->m[0][1], matrix->m[0][2], matrix->m[1][0], matrix->m[1][1], matrix->m[1][2], matrix->m[2][0], matrix->m[2][1], matrix->m[2][2]);
        return result;
    }

    Matrix34 Matrix34FromRotation(Matrix33 const* matrix) {
        Matrix34 result = Matrix34(matrix->m[0][0], matrix->m[0][1], matrix->m[0][2], 0, matrix->m[1][0], matrix->m[1][1], matrix->m[1][2], 0, matrix->m[2][0], matrix->m[2][1],
                                   matrix->m[2][2], 0);
        return result;
    }
}